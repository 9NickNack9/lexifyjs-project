...
export default function CorporateGovernance() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const text = await res.text(); // defensive parse for non-JSON bodies
      let json = null;
      try {
      ...
      <div className="w-full max-w-7xl p-6 rounded shadow-2xl bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {formData.areaboxes.includes(
              ...
              <>
                <br />
                <h4 className="text-md font-medium mb-1 font-semibold">
                  Please describe briefly for what purpose the corporate policy
                  is prepared (for example, what is the subject matter of the
                  policy and what is the target group to which the policy
                  applies){" "}
                  <QuestionMarkTooltip tooltipText="Please do not include any personal data in the description. This information will be visible to all legal service providers qualified to submit an offer in response to your LEXIFY Request." />
                </h4>
                <textarea
          ...
          <h4 className="text-md font-medium mb-1 font-semibold">
            ...
            example, a summary of how many and what kind of topics will be
            covered in the meeting if your LEXIFY Request seeks support with
            arranging a shareholders&apos; meeting). If you want, you can also
            upload a separate file with additional background information by
            clicking “Upload Background Info”
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      {formData.areaboxes.map((item, idx) => {
                        ...
                        return (
                          <li key={idx}>
                            <p>{item}</p>
                            {isFourth && formData.appDescription && (
                            ...
                            {isFifth && formData.policyDescription && (
                              <p className="ml-4 text-sm text-black">
