...
export default function OverMaxTable({ rows, onPreview }) {
  return (
    <div className="w-full mb-8">
      <h2 className="text-2xl font-semibold mb-4">
        Best Offers Exceeding My Maximum Price
      </h2>
        ...
        <table className="w-full border-collapse border border-gray-300 bg-white text-black">
          <thead>
            <tr className="bg-[#3a3a3c] text-white">
              ...
              <th className="border p-2 text-center">Expired Note</th>
          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.requestId}>
                ...
                <td className="border p-2 text-center">
                  Expired. Best offer over maximum price - awaiting approval or
                  rejection.
                </td>
                <td className="border p-2 text-center">
                  {r.offersReceived || 0}
