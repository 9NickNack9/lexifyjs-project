          ...
          <p className="text-xs">
            <em>
              <strong>
                ...
                my LEXIFY Request. The LEXIFY Contract will consist of i) the
                service description, other specifications and my Procurement
                Appendices (if applicable) as I have designated in the LEXIFY
                Request and ii) the General Terms and Conditions for LEXIFY
                Contracts. The LEXIFY Contract will not be generated if i) no
                qualifying offers have been received prior to the expiration of
                my LEXIFY Request or ii) I as representative of the legal
                service purchaser cancel the LEXIFY Request before any
