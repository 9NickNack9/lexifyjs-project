              ...
              <div key={index}>
                <label className="block">
                  ...
                  {option ===
                    "A sales contract template for the client's B2B business. The work includes preparation of the template documentation, necessary revisions based on client feedback and all related attorney-client communication." && (
                    <>
                      {" I need a sales contract template for my B2B business"}
              ...
              <div>
                ...
                <p className="text-xs">
                  ...
                  <em>
                    ...
                    accept such offer by confirming your acceptance within 72
          ...
          <p className="text-xs">
            <em>
              <strong>
                ...
                my LEXIFY Request. If my Winning Offer Selection Method in the
                ...
                specifications and my Procurement Appendices (if applicable) as
                I have designated in the LEXIFY Request and ii) the General
                Terms and Conditions for LEXIFY Contracts. The LEXIFY Contract
                will not be generated if i) no qualifying offers have been
                received prior to the expiration of my LEXIFY Request, ii) I as
                representative of the legal service purchaser cancel the LEXIFY
                Request or iii) if my Winning Offer Selection Method in the
                &quot;My Account&quot; menu has been set to &quot;Manual&quot;
                and I do not actively select any winning service provider within
                7 days of the expiration of the LEXIFY Request.
              </strong>
            </em>
          </p>
