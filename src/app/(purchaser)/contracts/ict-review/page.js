...
export default function IctReview() {
  ...
  const validate = () => {
    ...
    if (formData.templateboxes.includes("Other:") && !formData.otherTemplate)
      return "Please specify the 'Other' document.";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Reviewing an ICT/IT Contract Sent by a Supplier
      </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {formData.templateboxes.includes("Other:") && (
              <input
                type="text"
                name="otherTemplate"
                placeholder="Specify Other Template"
                className="w-full border p-2"
          ...
          <p className="text-xs pb-2">
            ...
            <em>
              ...
              provide for a legal review of the relevant document(s) sent by the
              supplier with proposed changes and legal observations included in
              writing. Additional work (for example, legal advice during further
          ...
          <h4 className="text-md font-medium mb-1 font-semibold">
            ...
            buying with the contract documentation sent by the supplier. Please
            also confirm the total number of pages in the documentation
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                <Section title="Scope of Work">
                  <p>
                    Legal review of the following ICT/IT related contract
                    documents provided by a supplier of the Client:
                  </p>
                  ...
                  <p className="pt-4">
                    The work includes a legal review of the document(s) listed
                    above with proposed changes and legal observations provided
                    to the Client in writing. Additional work (for example,
                    legal advice during further negotiation rounds) is not
                    included.
                  </p>
                </Section>
