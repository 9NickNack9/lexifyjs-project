...
const SCOPE_TITLE = "Legal review of an agreement sent by a supplier";
...
export default function SourcingComments() {
  ...
  const validateStep = (step) => {
    ...
    if (id === "background") {
      ...
      if (!formData.priceRange) {
        return {
          error: "Please select the expected value of the agreement.",
          field: "priceRange",
        };
      }
      return null;
  ...
  const drafts = useRequestDrafts({
    ...
    pagePath: "/contracts/sourcing-comments",
    formData,
    setFormData,
  ...
  useEffect(() => {
    window.__LEXIFY_REQUEST_CONTEXT__ = {
      requestType: "Sourcing Agreement Review",
  ...
  return (
    <>
      <form ref={wizard.formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Reviewing an Agreement Sent by a Supplier"
          steps={WIZARD_STEPS}
            ...
            <div className="space-y-6">
              <div data-field="description">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  you are buying with the agreement sent by the supplier. Please
                  also confirm the number of pages in the agreement sent by the
                  supplier
                ...
                <div className="mt-4 rounded-xl bg-[#e8f4f6] p-4 text-sm text-gray-700">
                  <p>
                    ...
                    and provide for a legal review of the agreement sent by the
                    supplier with proposed changes and legal observations
      ...
      >
        ...
        <Section title="Scope of Work">
          Legal review of a sourcing agreement provided by a supplier of the
          Client.
          <br />
          The work includes a legal review of the documentation referred to
          above with proposed changes and legal observations provided to the
          Client in writing. Additional work (for example, legal advice during
