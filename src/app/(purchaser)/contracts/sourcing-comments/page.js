...
export default function SourcingComments() {
  ...
  const REQUEST_DRAFT_TYPE = "sourcingComments";
  const DRAFT_EMPTY_TEXT = "No saved Sourcing Agreement Review drafts found.";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Reviewing an Agreement Sent by a Supplier
      </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex justify-between items-start gap-4 mb-2">
            <h4 className="text-md font-medium font-semibold">
              ...
              are buying with the agreement sent by the supplier. Please also
              confirm the number of pages in the agreement sent by the supplier
          ...
          <p className="text-xs pb-2">
            ...
            <em>
              ...
              provide for a legal review of the agreement sent by the supplier
              with proposed changes and legal observations included in writing.
              Additional work (for example, legal advice during further
              negotiation rounds) is not included.
            </em>
          </p>
          <hr />
          <br />
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              What is the the expected value of the agreement?
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                <Section title="Scope of Work">
                  Legal review of a sourcing agreement provided by a supplier of
                  the Client.
                  <br />
                  The work includes a legal review of the documentation referred
                  to above with proposed changes and legal observations provided
                  to the Client in writing. Additional work (for example, legal
                ...
                {/* Description */}
                <Section title="Description of the Product or Service the Client is Buying with the Sourcing Agreement under Negotiation; Total Number of Pages of Agreement Documentation Requiring Legal Review.">
