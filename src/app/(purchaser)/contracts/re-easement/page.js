...
export default function ReEasement() {
  ...
  const DRAFT_EMPTY_TEXT = "No saved Easement Agreement drafts found.";
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              ...
              counterparty in the easement agreement. Please provide also the
              property identification codes or corresponding identifiers of the
              properties included in the easement agreement. If you do not want
          ...
          <h4 className="text-md font-medium mb-1 font-semibold">
            ...
            agreement and the easement(s) to be established with the easement
            agreement{" "}
