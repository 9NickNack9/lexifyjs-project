...
export default function FinanceBreachWaiver() {
  ...
  const REQUEST_DRAFT_TYPE = "bankingWaiver";
  const DRAFT_EMPTY_TEXT = "No saved Breach Waiver drafts found.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        requestSubcategory: "Breach Waiver",
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Breach Waiver (Finance Documents)
      </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              Are you the lender or the borrower in the waiver process?
            </h4>
            <select
              name="refinanceType"
          ...
          <div>
            {["I am the lender"].includes(formData.refinanceType) && (
              <>
                <div>
                  <h4 className="text-md font-medium mb-1 font-semibold">
                    In the waiver process, are you acting only on your own
                    ...
                    <>
                      <div>
                        <h4 className="text-md font-medium mb-1 font-semibold">
                          ...
                          lenders (for example, a coordinator or a facility
                          agent) and provide the name, business identity code
                          and country of domicile of the other lenders involved
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              ...
              domicile of your counterparty in the waiver process.
            </h4>
            <textarea
              name="counterparty"
              className="w-full border p-2"
          ...
          <br />
          <h4 className="text-md font-medium mb-1 font-semibold">
            Please describe the breach(es) in respect of which the waiver is
            sought and the finance documents that have been breached.
          </h4>
          <textarea
            name="description"
            className="w-full border p-2"
            ...
            <div className="bg-white w-11/12 max-w-4xl shadow-lg overflow-y-auto max-h-[90vh] animate-fadeInScale relative">
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                {/* Is the Client the Lender of the Borrower in the Breach Waiver Process? */}
                <Section title="Is the Client the Lender of the Borrower in the Breach Waiver Process?">
                  <p>{formData.refinanceType || "-"}</p>
                </Section>

                {/* Is the Client Acting Only on Its Own Behalf or Also on Behalf of Other Lenders in the Breach Waiver Process? */}
                {["I am the lender"].includes(formData.refinanceType) && (
                  <Section title="Is the Client Acting Only on Its Own Behalf or Also on Behalf of Other Lenders in the Breach Waiver Process?">
                ...
                {/* Counterparty */}
                <Section title="Name, Business Identity Code and Country of Domicile of the Client's Counterparty in the Breach Waiver Process">
                  {formData.counterparty}
                </Section>

                {/* Description of the breach(es) in respect of which the waiver is sought and the finance documents that have been breached. */}
                <Section title="Description of the Breach(es) in Respect of Which the Waiver Is Sought and the Finance Documents That Have Been Breached">
