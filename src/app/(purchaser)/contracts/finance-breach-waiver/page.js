...
const PAGE_PATH = "/contracts/finance-breach-waiver";
  ...
  const drafts = useRequestDrafts({
    ...
    applyDraftData: (prev, draft) => {
      const next = {
        ...
        supportType: draft.data?.supportType || NEED_WAIVER,
        backgroundFiles: [],
        supplierFiles: [],
        agree: false,
      };
  ...
  const validateStep = (step) => {
    ...
    if (step === 2) {
      if (!formData.description) {
        return {
          error:
            "Please describe the breach(es) in respect of which the waiver is sought.",
          field: "description",
        };
      }
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Breach Waiver (Finance Documents)"
          steps={WIZARD_STEPS}
          ...
          {currentStep === 2 ? (
            <div className="space-y-6">
              <div data-field="description">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  Please describe the breach(es) in respect of which the waiver
                  is sought and the finance documents that have been breached.
                </h4>
                <AutoGrowTextarea
                  name="description"
                  className={FIELD_CLASS}
              ...
              {showRelationRole ? (
                <div data-field="relationRole">
                  <h4 className="mb-2 text-sm font-semibold text-gray-900">
                    ...
                    the other lenders involved in the waiver process.
                  </h4>
                  <AutoGrowTextarea
                    name="relationRole"
                    className={FIELD_CLASS}
          ...
          {currentStep === 5 ? (
            <div className="space-y-6">
              <dl className="rounded-xl border border-gray-200 px-4">
                ...
                />
                <SummaryRow
                  label="Description of breach and documents"
                  value={formData.description}
                />
                <SummaryRow
                  label="Counterparty"
