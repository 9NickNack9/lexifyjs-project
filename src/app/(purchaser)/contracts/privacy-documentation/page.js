...
export default function PrivacyDocumentation() {
  ...
  const handleChange = (e) => {
    ...
    if (type === "checkbox") {
      if (name === "agree") {
        ...
        setFormData({
          ...
          individualBoxes: checked
            ? [...formData.individualBoxes, value]
            : formData.individualBoxes.filter((v) => v !== value),
        });
      } else {
        setFormData({
          ...formData,
      ...
      setFormData({ ...formData, documentCoverage: value });
    } else {
  ...
  const validate = () => {
    ...
    if (!formData.documentType)
      return "Choose whether you need templates or fully finalized documents.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const details = {
        ...
        documentTemplateContext: formData.documentTemplate || "",
        documentCoverage:
          formData.documentCoverage === "Other"
            ? formData.otherCoverage
            : formData.documentCoverage || "",
        individuals: [
          ...(formData.individualBoxes || []).filter((x) => x !== "Other"),
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Data Privacy related Documents
      </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {[
            ...
            <label key={index} className="block">
              ...
              {option}
              {index === 0 && (
                <QuestionMarkTooltip tooltipText="A Privacy Statement or Privacy Notice is a document that explains how an organization collects, uses, stores, and protects personal data. For example, a privacy statement made available on a company's website or attached to a company's marketing communications. " />
              )}
              {index === 2 && (
                <QuestionMarkTooltip tooltipText="A Record of Processing Activities (ROPA) is a documented overview of how an organization collects, uses, shares, and stores personal data. Maintaining a ROPA is a legal requirement under GDPR for most organizations. " />
              )}
              {index === 3 && (
                <QuestionMarkTooltip tooltipText="Personal Data Protection Impact Assessment (DPIA) is a process and related documentation used to identify and minimize the privacy risks of processing personal data. " />
              )}
              {index === 4 && (
                <QuestionMarkTooltip tooltipText="A Balancing Test is used to determine whether an organization's legitimate interest in processing personal data outweighs the individual's rights and freedoms. It's required under laws like the GDPR when relying on “legitimate interest” as the legal basis for processing. " />
              )}
            </label>
          ))}
          ...
          <p className="text-xs">
            ...
            <em>
              ...
              include the preparation of the document(s) and necessary revisions
              on the basis of your feedback to the legal service provider.
            </em>
          </p>
          <br />
          <hr />
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              ...
              fully completed with required information related specifically to
              your business (for example, a privacy statement for your
              company&apos;s website)?
            </h4>
            <select
              name="documentType"
            ...
            {formData.documentType.includes(
              ...
              <>
                <h4 className="text-md font-medium mb-1 font-semibold pt-4">
                  ...
                  statement template, will it be used only internally to inform
                  your employees of their personal data processing or more
                  broadly (for instance, also on your company&apos;s website)?
            ...
            {formData.documentType.includes(
              ...
              <>
                ...
                <br />
                <h4 className="text-md font-medium mb-1 font-semibold">
                  Please specify the group(s) of individuals whose personal data
                  is concerned:
                </h4>
                {[
                  "Employees",
                  ...
                  <label key={index} className="block">
                    <input
                      type="checkbox"
                      name="individualBoxes"
                      value={option}
                      checked={formData.individualBoxes.includes(option)}
                      onChange={handleChange}
                    />{" "}
                    {option}
                  </label>
                ))}
                {formData.individualBoxes.includes("Other") && (
                  <input
                    type="text"
                    name="otherIndividiual"
                    placeholder="Please Specify Other Group(s)"
                    className="w-full border p-2"
                    value={formData.otherIndividiual}
                    onChange={handleChange}
                  />
                )}
                <br />
                ...
                <div className="space-y-2">
                    ...
                    <div key={index}>
                      <label className="block">
                        <input
                          ...
                          value={option}
                          checked={formData.documentCoverage === option}
                          onChange={handleChange}
                        />
                        {option ===
                          "A single IT application, solution, product or activity (for example, online store, gaming application or employee survey)" &&
                  ...
                  {formData.documentCoverage.includes("Other") && (
                    <input
                      type="text"
                      name="otherCoverage"
                ...
                <h4 className="text-md font-medium mb-1 font-semibold">
                  ...
                  required document(s). Specify, for example, what kind of data
                  is collected and what kind of technology is used to collect
                  the data. You can also upload data mapping, data flow or data
                  architecture documentation for background by clicking the
                  &quot;Upload Background Info&quot; button further below.
                </h4>
                <textarea
                ...
                <Section title="Scope of Work">
                  <>
                    <p className="text-md mt-2">
                      Legal support with preparing the following data privacy
