...
const PAGE_PATH = "/contracts/re-sale";
const REQUEST_DRAFT_TYPE = "reSale";
...
export default function ReSale() {
  ...
  const drafts = useRequestDrafts({
    ...
    formData,
    setFormData,
    emptyText: "No saved Sale and Purchase drafts found.",
  ...
  useEffect(() => {
    window.__LEXIFY_REQUEST_CONTEXT__ = {
      requestType: "Sale and Purchase of Real Estate",
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Sale and Purchase (Commercial or Residential Real Estate)"
          steps={WIZARD_STEPS}
