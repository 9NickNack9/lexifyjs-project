...
const PAGE_PATH = "/contracts/re-landuse";
const REQUEST_DRAFT_TYPE = "reLanduse";
...
export default function ReLandUse() {
  ...
  const drafts = useRequestDrafts({
    ...
    formData,
    setFormData,
    emptyText: "No saved Land Use Agreement drafts found.",
  ...
  useEffect(() => {
    window.__LEXIFY_REQUEST_CONTEXT__ = {
      requestType: "Land Use Agreement",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const paymentRate = isHourly
        ? "Blended Hourly Rate. The total price of the service will be calculated by multiplying the hourly rate with the number of hours of legal support provided by the Legal Service Provider. The offered hourly rate will be valid until the land use agreement has been signed or abandoned."
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Land Use Agreement"
          steps={WIZARD_STEPS}
            ...
            <div className="space-y-6">
              <div data-field="description">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  agreement and the arrangement(s) to be established with the
                  land use agreement{" "}
              ...
              <div data-field="confidential">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  counterparty in the land use agreement. Please provide also
                  the property identification codes or corresponding identifiers
                  of the properties included in the land use agreement. If you
          ...
          {currentStep === 4 ? (
            <div className="space-y-6">
              <dl className="rounded-xl border border-gray-200 px-4">
                ...
                />
                <SummaryRow
                  label="Properties and arrangements"
                  value={formData.description}
                />
                <SummaryRow
                  label="Counterparty"
                ...
                {isHourly ? (
                  <>
                    ...
                    <p className="mt-2 text-md">
                      ...
                      offered hourly rate will be valid until the land use
