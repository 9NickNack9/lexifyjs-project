  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Amendment of Existing Debt Terms
      </h2>
      ...
      <div className="w-full max-w-7xl p-6 rounded shadow-2xl bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <h4 className="text-md font-medium mb-1 font-semibold">
            ...
            agreement to be amended and the amendments to be implemented (for
            example, a term loan facility, a revolving loan facility, a
            guarantee facility, etc.). Please also confirm whether any new
            ancillary facility (for example, to allow the use of a bilateral
            credit limit) is to be implemented.
            ...
            <div className="bg-white w-11/12 max-w-4xl shadow-lg overflow-y-auto max-h-[90vh] animate-fadeInScale relative">
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                  ...
                  {formData.supportType.includes(
                    ...
                    <>
                      ...
                      <p className="text-md mt-2">
                        ...
                        will be valid until the amendment process has been
                        completed or abandoned, whichever comes first.
                      </p>
                    </>
                  ) : (
                    `Lump Sum Fixed Fee ${
                ...
                {/* Is the Client the Lender of the Borrower in the Amendment Process? */}
                <Section title="Is the Client the Lender of the Borrower in the Amendment Process?">
                  <p>{formData.refinanceType || "-"}</p>
                </Section>

                {/* Is the Client Acting Only on Its Own Behalf or Also on Behalf of Other Lenders in the amendment Process? */}
                {["I am the lender"].includes(formData.refinanceType) && (
                ...
                {/* Description of the Facility/Facilities Agreement to Be Amended and the Amendments to Be Implemented */}
                ...
                {/* Description of the Asset(s) To Be Used As Collateral */}
                {[
                  "Secured - the debt will be backed by specific collateral",
                ].includes(formData.debtSecurance) && (
