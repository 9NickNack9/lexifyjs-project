...
const NEED_OPTIONS = [
  ...
  {
    value: NEED_LEASE,
    title: "A lease agreement (including revisions based on client feedback)",
    pricing: "Lump sum fixed price",
    note: LUMP_SUM_NOTE,
...
const PAGE_PATH = "/contracts/re-lease";
const REQUEST_DRAFT_TYPE = "reLease";
...
export default function ReLease() {
  ...
  const drafts = useRequestDrafts({
    ...
    formData,
    setFormData,
    emptyText: "No saved Lease Agreement drafts found.",
  ...
  const validateStep = (stepIndex) => {
    ...
    if (stepId === "transaction") return null;
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Lease Agreement"
          steps={WIZARD_STEPS}
            ...
            <div className="space-y-6">
              ...
              <div data-field="confidential">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  domicile of your counterparty in the lease agreement. If you
          ...
          {currentStep === 5 ? (
            <div className="space-y-6">
              <dl className="rounded-xl border border-gray-200 px-4">
                ...
                />
                <SummaryRow label="Lease type" value={formData.agreementType} />
                <SummaryRow
                  label="Lessor/lessee"
                  value={formData.customerType}
                />
          ...
          {isHourly ? (
            <>
              ...
              <p className="mt-2 text-md">
                ...
                will be valid until the lease agreement has been signed or
