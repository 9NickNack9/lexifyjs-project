...
export default function SourcingAgreement() {
  ...
  const validate = () => {
    ...
    if (
      ...
      return "Please describe the product/service type for the customized template.";
    ...
    if (!formData.maxPrice) return "Please set a maximum price (VAT 0%).";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        offersDeadline: formData.date, // API will convert to local end-of-day
        title: formData.requestTitle,
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Preparing a Sourcing Agreement Template
      </h2>
      ...
      <div className="fw-full max-w-7xl p-6 rounded shadow-2xl text-black bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#19999e] text-white border border-black rounded hover:opacity-90 cursor-pointer"
              >
                Load Draft
              </button>
            </div>
              ...
              <div key={index}>
                <label className="block">
                  <input
                    ...
                    name="templateType"
                    value={option}
                    checked={formData.templateType === option}
          ...
          <div>
            {[
              "Customized for the buying of a specific product or service type",
            ].includes(formData.templateType) && (
              <div>
