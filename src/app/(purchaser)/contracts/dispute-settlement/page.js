...
export default function DisputeSettlement() {
  ...
  const isFullSettlement = formData.need.startsWith(
  ...
  const validate = () => {
    ...
    if (isFullSettlement && !formData.maxPrice) {
      return "Set a maximum price (VAT 0%) for full settlement negotiation support.";
    }
    const langs = [
      ...
      <div className="w-full max-w-7xl p-6 rounded shadow-2xl bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div key={index}>
                ...
                <p className="text-xs pb-2">
                  ...
                  <em>
                    {option ===
                    "Full legal representation in settlement negotiations (including, for example, drafting of a settlement agreement, negotiations with the counterparty and related attorney-client communications)"
                      ? "Any offers you receive will be for a lump sum fixed price and cover the pending settlement negotiations only."
          ...
          <h4 className="text-md font-medium mb-1 font-semibold">
            ...
            domicile of your counterparty in the settlement negotiations. If you
          ...
          <h4 className="text-md font-medium mb-1 font-semibold">
            ...
            status of the settlement negotiations (What has happened in the
            negotiations so far? Are you currently expected to provide an offer,
            a response or other communication to the counterparty by a fixed
            deadline?){" "}
