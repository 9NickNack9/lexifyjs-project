...
const NEED_OPTIONS = [
  {
    ...
    note: "Any offers you receive will be for a lump sum fixed price and cover the pending settlement negotiations only.",
    icon: "template",
  },
  {
...
const PAGE_PATH = "/contracts/dispute-settlement";
const REQUEST_DRAFT_TYPE = "settlementNegotiations";
const DRAFT_EMPTY_TEXT = "No saved Settlement Negotiation drafts found.";
...
export default function DisputeSettlement() {
  ...
  const isFullSettlement = isFullNeed(formData.need);
  const isFixedFee = isFullSettlement;
  ...
  const validateStep = (step) => {
    ...
    if (step === 2) {
      if (!formData.description) {
        return {
          error:
            "Please describe briefly the matter under dispute and the current status of the settlement negotiations.",
          field: "description",
        };
      }
      return null;
  ...
  useEffect(() => {
    window.__LEXIFY_REQUEST_CONTEXT__ = {
      requestType: "Settlement Negotiation",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        requestSubcategory: "Settlement Negotiation Support",
        scopeOfWork: formData.need,
        description: formData.description || "",
        additionalBackgroundInfo: formData.background || "",
        backgroundInfoFiles: [],
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Settlement Negotiations"
          steps={WIZARD_STEPS}
            ...
            <div className="space-y-6">
              <div data-field="confidential">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  domicile of your counterparty in the settlement negotiations.
            ...
            <div className="space-y-6">
              <div data-field="description">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  current status of the settlement negotiations (What has
                  happened in the negotiations so far? Are you currently
                  expected to provide an offer, a response or other
                  communication to the counterparty by a fixed deadline?){" "}
      ...
      >
          ...
          {formData.need.includes(NEED_FULL) ? (
            <>
              ...
              <p className="text-md mt-2">
                The lump sum fixed fee covers the pending settlement
                negotiations.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-md mt-2">
                ...
                offer. The offered hourly rate will be valid until a settlement
                agreement has been signed or until the pending settlement
                negotiations have otherwise concluded.
              </p>
            </>
          )}
          <p className="text-md mt-2">
        ...
        <Section title="Description of Disputed Matter and Current Status of Settlement Negotiations">
