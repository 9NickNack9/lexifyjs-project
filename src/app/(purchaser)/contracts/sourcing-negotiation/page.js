  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Negotiating a Sourcing Agreement
      </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex justify-between items-start gap-4 mb-2">
            <h4 className="text-md font-medium font-semibold">
              Please provide a brief description of the product or service you
              are buying with the agreement under negotiation
          ...
          <p className="text-xs pb-2">
            ...
            <em>
              ...
              during the negotiation process as needed (for example, commenting
              on agreement documentation or legal advice during different stages
              of the negotiation process). Any offers you receive will include
              an applicable hourly rate only. The total price of the service
              will be calculated by multiplying the hourly rate with the number
              of hours of legal support provided by the legal service provider
              submitting the winning offer. The offered hourly rate will be
              valid until the sourcing agreement has been signed or abandoned,
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              ...
              supplier to be visible to all legal service providers qualified to
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              Is the sourcing agreement being negotiated on your own contract
              template or the supplier&apos;s template?
              <QuestionMarkTooltip tooltipText="This information will be visible to all legal service providers qualified to submit an offer in response to your LEXIFY Request." />
            </h4>
            <select
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                <Section title="Scope of Work">
                  ...
                  sourcing agreement documentation or legal advice during
                ...
                <Section title="Contract Price (Lump Sum Fixed Fee or Flat Hourly Rate) and Currency">
                  Flat hourly rate. The total price of the service will be
                  calculated by multiplying the hourly rate with the number of
                  hours of legal support provided by the Legal Service Provider.
                  The hourly rate offered by the Legal Service Provider will be
                  valid until the sourcing agreement has been signed or
