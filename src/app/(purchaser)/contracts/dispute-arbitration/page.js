              ...
              <div key={index}>
                ...
                <p className="text-xs pb-2">
                  ...
                  <em>
                    {option ===
                    "Full legal representation in pending arbitration proceedings (including, for example, drafting of legal briefs, representation in arbitration hearings and related attorney-client communications)"
                      ? "Any offers you receive will be for a lump sum fixed price and cover the pending arbitration proceedings only. Any offers you receive will not include fees or charges possibly levied by the competent arbitration tribunal and such fees and charges, if any, will be invoiced separately."
                  ...
                  {formData.need.includes(
                    ...
                    <>
                      ...
                      <p className="text-md mt-2">
                        The lump sum fixed fee covers the pending arbitration
                        proceedings only and does not include fees or charges
                        possibly levied by the competent arbitration tribunal
                        which fees and charges, if any, will be invoiced
                        separately.
                      </p>
                    </>
                  ) : (
