...
export default function DisputeArbitration() {
  ...
  const isFullArbitration = formData.need.startsWith(
  ...
  const validate = () => {
    ...
    if (isFullArbitration && !formData.maxPrice) {
      return "Set a maximum price (VAT 0%) for full arbitration representation.";
    }
    const langs = [
