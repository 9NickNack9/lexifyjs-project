...
export default function ReConstruction() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const paymentRate = isHourly ? "Hourly Rate" : "Lump sum fixed price";
      const languageCSV = [
        ...(formData.checkboxes || []).filter((l) => l !== "Other:"),
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              ...
              do not want the name of the counterparty to be visible to all
              legal service providers qualified to make you an offer, please
