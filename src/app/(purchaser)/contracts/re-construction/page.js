...
export default function ReConstruction() {
  ...
  const DRAFT_EMPTY_TEXT = "No saved Construction Contract drafts found.";
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label className="block">
                  ...
                  {option ===
                    ...
                    <>
                      ...
                      <QuestionMarkTooltip tooltipText="The work does not include drafting of scope of construction work descriptions or other non-legal documents of primarily technical nature. " />
                    </>
                  )}
                  {option ===
                    "Occasional legal support with the construction contract negotiation process when needed (for example, commenting of construction contract documentation or legal advice during different stages of the process)." &&
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              ...
              domicile of your counterparty in the construction contract. If you
              do not want your name and the name of the counterparty to be
          ...
          <br />
          <h4 className="text-md font-medium mb-1 font-semibold">
            Please provide a brief description of the construction work to be
            performed under the construction contract and the site or location
            of the work{" "}
            ...
            <div className="bg-white w-11/12 max-w-4xl shadow-lg overflow-y-auto max-h-[90vh] animate-fadeInScale relative">
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                {/* Client's Role in the Construction Contract */}
