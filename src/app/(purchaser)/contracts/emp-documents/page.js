...
export default function EmploymentDocs() {
  ...
  const DRAFT_EMPTY_TEXT =
    "No saved Employment Document Template drafts found.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const scope = [
        ...formData.areaboxes.filter((x) => x !== "Other Template(s)"),
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Employment related Document Templates
      </h2>
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                <Section title="Scope of Work">
                  <p>
                    Preparation of the following employment related document
