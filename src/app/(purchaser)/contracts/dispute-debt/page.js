...
export default function DisputeDebt() {
  ...
  const initialFormState = {
    need: "", // radio: letter vs occasional
    confidential: "",
    confboxes: [],
    description: "",
    background: "",
  ...
  const isDebtLetter = formData.need.startsWith(
  ...
  const validate = () => {
    ...
    if (isDebtLetter && !formData.maxPrice) {
      return "Set a maximum price (VAT 0%) for the debt collection letter.";
    }
    const langs = [
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">Help with Debt Collection</h2>
      ...
      <div className="w-full max-w-7xl p-6 rounded shadow-2xl bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label className="block">
                  ...
                  {option ===
                    ...
                    <>
                      ...
                      <QuestionMarkTooltip tooltipText="Any offers you receive will include the preparation of the legal letter, necessary revisions on the basis of your feedback to the legal service provider and sending of the legal letter to the debtor." />
                    </>
                  )}
                  {option ===
                    "Occasional legal support with a debt collection process (including, for example, legal review of communications from the debtor or legal advice regarding next steps during different stages of the collection process, if requested)." &&
          ...
          <br />
          <h4 className="text-md font-medium mb-1 font-semibold">
            Please describe briefly the debt you are collecting (What is the
            amount of the receivable and on what grounds are you collecting it?
            What actions have you taken so far to collect the receivable? On
            what grounds is the debtor refusing to pay the receivable?)
                  ...
                  {formData.need.includes(
                    ...
                    <>
                      ...
                      <p className="text-md mt-2">
                        ...
                        The offered hourly rate will be valid until the relevant
                        outstanding debt(s) has been collected or the collection
                        of the relevant outstanding debt(s) has been abandoned,
