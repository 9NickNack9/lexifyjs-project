...
export default function IctTemplate() {
  ...
  const REQUEST_DRAFT_TYPE = "ictTemplate";
  const DRAFT_EMPTY_TEXT = "No saved ICT/IT Contract Template drafts found.";
  ...
  const validate = () => {
    ...
    if (formData.templateboxes.includes("Other:") && !formData.otherTemplate)
      return "Please specify the 'Other' template.";
    ...
    if (!formData.maxPrice) return "Set a maximum price.";
    ...
    try {
      ...
      const payload = {
        ...
        scopeOfWork:
          ...
          scopeList +
          "The work includes the preparation of the listed document(s) and necessary revisions on the basis of the Client's feedback to the Legal Service Provider.",
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Preparing an ICT/IT Contract Template
      </h2>
              ...
              */}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                <Section title="Scope of Work">
                  <p>
                    Preparation of the following ICT/IT related contract and/or
                    document template(s) for the Client:
                  </p>
                  ...
                  <p className="pt-4">
                    The work includes the preparation of the listed document(s)
                    and necessary revisions on the basis of the Client&apos;s
