...
export default function EmploymentContract() {
  ...
  const DRAFT_EMPTY_TEXT =
    "No saved Employment Contract Template drafts found.";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <h2 className="text-2xl font-semibold mb-6">
        Help with Employment Contract Templates
      </h2>
      ...
      <div className="w-full max-w-7xl p-6 rounded shadow-2xl bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <h4 className="text-md font-medium font-semibold mb-1">
            Briefly describe the position and tasks of the employee or employee
            group for whom the contract template is prepared{" "}
              ...
              <div id="lexify-preview" className="space-y-6 text-black p-8">
                ...
                <Section title="Scope of Work">
                  {formData.areaboxes ? (
                    <>
                      <p>
                        Preparation of the following employment contract
