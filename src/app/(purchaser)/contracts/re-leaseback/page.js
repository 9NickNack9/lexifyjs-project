...
export default function ReLeaseback() {
  ...
  const DRAFT_EMPTY_TEXT = "No saved Sale and Leaseback drafts found.";
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      ...
      <div className="w-full max-w-7xl p-6 rounded shadow-2xl text-black bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <h4 className="text-md font-medium mb-1 font-semibold">
              Are you buying (and leasing as lessor) or selling (and leasing as
              lessee)?
            </h4>
            <select
              name="customerType"
