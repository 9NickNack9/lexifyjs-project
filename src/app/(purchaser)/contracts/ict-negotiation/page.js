...
const REQUEST_DRAFT_TYPE = "ictNegotiation";
const PAGE_PATH = "/contracts/ict-negotiation";
const DRAFT_EMPTY_TEXT = "No saved ICT/IT Contract Negotiation drafts found.";
...
const WIZARD_STEPS = [
  {
    id: "docs",
    label: "Documents under negotiation",
    title: "What kind of contract document(s) are you negotiating?",
  },
  { id: "company", label: "Who is involved", title: "Who is involved?" },
  {
    id: "extra",
    label: "Contract details",
    title: "Contract value and template",
  },
...
export default function IctNegotiation() {
  ...
  const validateStep = (step) => {
    if (step === 0) {
      if (templateboxes.length === 0) {
        return {
          error: "Please choose at least one contract document type.",
          field: "templateboxes",
        };
      }
    ...
    if (step === 2) {
      ...
      if (!formData.negotiationType) {
        return {
          error: "Select whose template is used (yours or counterparty).",
  ...
  useEffect(() => {
    window.__LEXIFY_REQUEST_CONTEXT__ = {
      requestType: "ICT/IT Contract Negotiation",
      legalArea: [
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} noValidate>
        <RequestWizard
          categoryLabel="Help with Negotiating an ICT/IT Contract"
          steps={WIZARD_STEPS}
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3 rounded-xl bg-[#e8f4f6] p-4 text-sm text-gray-700">
                <p>
                  ...
                  support during the negotiation process as needed (for example,
                  ...
                  by the legal service provider submitting the winning offer.
                  The offered hourly rate will be valid until the agreement has
              ...
              <div data-field="description">
                <h4 className="mb-2 text-sm font-semibold text-gray-900">
                  ...
                  you are buying or selling with the contract under negotiation
          ...
          {currentStep === 5 && (
            <div className="space-y-6">
              <dl className="rounded-xl border border-gray-200 px-4">
                <SummaryRow
                  label="Negotiation support required with following documents"
                  value={scopeSummary}
                />
                <SummaryRow
      ...
      >
        ...
        <Section title="Scope of Work">
          <p>
            Legal support with negotiating the following ICT/IT related contract
            document(s):
          </p>
          {templateboxes.length > 0
            ...
            : "-"}
          <p className="pt-4">
            The legal support can include, for example, commenting on agreement
            documentation or legal advice during different stages of the
            negotiation process.
          </p>
        </Section>
